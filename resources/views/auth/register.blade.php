            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Mobile No ') }}</label>
                            ...
                            <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Name of Organization ') }}</label>

                            <div class="col-md-6">
                                <input id="mobile_no" type="text" class="form-control @error('name_of_organization') is-invalid @enderror" name="name_of_organization" value="{{ old('name_of_organization') }}" required autocomplete="name_of_organization">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Street ') }}</label>
